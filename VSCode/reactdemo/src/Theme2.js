...
const MyComponent2 = () => {
  ...
  const storedBgImageUrl1 = localStorage.getItem('bgImageUrl1');
  ...
  const handleFileChange = (event) => {
    ...
    localStorage.setItem('bgImageUrl1', fileUrl);
  };
          ...
          <div className="row">
            <div className="col-md-4 col-4">
              <div className="first-line">
                ...
                {/* <img src="image/image-4.png" width="500px" className="img-fluid rotate pd-img" alt="" /> */}
              </div>
            </div>
